...
forest_plot <- function(dat, subgroup_input, width_input, height_input, xlim_low, xlim_high,
                        table_name, figure_name){
  ...
  dt <- data.table(Pathogen       = ma.data$data$Pathogen, 
                   Classification = ma.data$byvar,
  ...
  fwrite (x    = dt,
          file = file.path("tables", table_name))
...
los_res_typhi <- forest_plot(dat            = dat_stu_hos_res_typhi,
                             ...
                             xlim_low       = 1, 
                             xlim_high      = 15,
                             table_name     = "length_of_hospital_stay_res_typhi.csv",
...
los_sus_typhi <- forest_plot(dat            = dat_stu_hos_sus_typhi,
                             ...
                             xlim_low       = 1, 
                             xlim_high      = 15,
                             table_name     = "length_of_hospital_stay_sus_typhi.csv",
...
los_res_nontyphi <- forest_plot(dat            = dat_stu_hos_res_nontyphi,
                                ...
                                xlim_low       = 1, 
                                xlim_high      = 15,
                                table_name     = "length_of_hospital_stay_res_nontyphi.csv",
...
los_sus_nontyphi <- forest_plot(dat            = dat_stu_hos_sus_nontyphi,
                                ...
                                xlim_low       = 1, 
                                xlim_high      = 15,
                                table_name     = "length_of_hospital_stay_sus_nontyphi.csv",
...
fev_res_typhi <- forest_plot(dat            = dat_stu_fev_res_typhi,
                             ...
                             xlim_low       = 1, 
                             xlim_high      = 30,
                             table_name     = "duration_of_fever_res_typhi.csv",
...
fev_sus_typhi <- forest_plot(dat            = dat_stu_fev_sus_typhi,
                             ...
                             xlim_low       = 1, 
                             xlim_high      = 30,
                             table_name     = "duration_of_fever_sus_typhi.csv",
...
fev_res_nontyphi <- forest_plot(dat         = dat_stu_fev_res_nontyphi,
                             ...
                             xlim_low       = 1, 
                             xlim_high      = 30,
                             table_name     = "duration_of_fever_res_nontyphi.csv",
...
fev_sus_nontyphi <- forest_plot(dat         = dat_stu_fev_sus_nontyphi,
                             ...
                             xlim_low       = 1, 
                             xlim_high      = 30,
                             table_name     = "duration_of_fever_sus_nontyphi.csv",
